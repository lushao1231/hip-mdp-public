...
# with open(domain+'_preset_hidden_params','rb') as f:
with open('preset_parameters/'+domain+'_preset_hidden_params','rb') as f:
    preset_parameters = pickle.load(f, encoding='latin1')
    
# print("preset_parameters: ")
# print(preset_parameters)
run_type = 'modelfree'
num_batch_instances = 8
